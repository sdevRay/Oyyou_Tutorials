...
namespace Tutorial016
{
	...
	public class Game1 : Game
	{
		...
		protected override void Initialize()
		{
			...
			_pos1 = new Vector2(100, 100);
			_pos2 = new Vector2(125, 100);
		...
		protected override void Draw(GameTime gameTime)
		{
			...
			spriteBatch.Draw(_texture, _pos1, null, Color.Red, 0f, new Vector2(0, 0), 1f, SpriteEffects.None, 0.1f);
			spriteBatch.Draw(_texture, _pos2, null, Color.Blue, 0f, new Vector2(0, 0), 1f, SpriteEffects.None, 0);
